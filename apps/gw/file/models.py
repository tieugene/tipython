...
#from apps.gw.file.views import file_detail
...
class    File(Object, RenameFilesModel):
    ...
    def get_absolute_url(self):
        return LOGIN_REDIRECT_URL+"gw/file/view/%i/" % self.id
    ...
    def    save(self):
        ...
        #print self.file.name, self.file.path, self.file._file.__dict__
