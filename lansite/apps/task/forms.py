...
class	ChoiceForm(forms.Form):
	...
	From apps.core
	'''
	object	= forms.ModelChoiceField(queryset=None, empty_label=None)
	def	__init__(self, q, *args, **kwargs):
		super(ChoiceForm, self).__init__(*args, **kwargs)
		self.fields['object'].queryset = q
...
class	FilterForm(forms.Form):
	...
	Set filter
	'''
	user		= forms.ModelChoiceField(queryset=User.objects.all(), required=False, label="Автор")
	...
	attendee	= forms.ModelChoiceField(queryset=User.objects.all(), required=False, label="Участник")
